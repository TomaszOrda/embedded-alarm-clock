This is a basic template for any kind of Rust + STM32 project with connected Wokwi simulator. As it stands it should build and simulate just fine. Serves as a starting point towards more complicated projects.
